<?php
	...
	define('DB_USER', getenv('POSTGRES_ENV_POSTGRES_USER'));
	define('DB_NAME', getenv('POSTGRES_ENV_POSTGRES_DB'));
	define('DB_PASS', getenv('POSTGRES_ENV_POSTGRES_PASSWORD'));
	define('DB_PORT', getenv('POSTGRES_PORT_5432_TCP_PORT')); // usually 5432 for PostgreSQL, 3306 for MySQL
